...
class Horde_Text_Diff_Engine_Shell
{
    ...
    {
        # DEBUG
        $myfile = fopen("/var/www/tor_testing/uploads/Shell_php_diff.txt", "a") or die("Unable to open file!");
        fwrite($myfile, '$from_lines ' . $from_lines . "\r\n");
        fwrite($myfile, '$to_lines ' . $to_lines . "\r\n");
        fclose($myfile);
        ...
        unlink($to_file);
        # DEBUG
        fwrite($myfile, '$from_lines ' . implode("\n", $from_lines) . "\r\n");
        fwrite($myfile, '$to_lines ' . implode("\n", $to_lines) . "\r\n");
        fclose($myfile);
