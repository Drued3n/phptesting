...
//# DEBUG
//$myfile = fopen("/var/www/tor_testing/uploads/config_php_called.txt", "a") or die("Unable to open file!");
//$date_ = date('m/d/Y h:i:s a', time());
//fwrite($myfile, "$date_\t"."no vars " . "\r\n");
//fclose($myfile);
...
$config['database']['database'] = 'tor_testingDB';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'root';
$config['database']['password'] = 'Random0!';
